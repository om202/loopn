...
export function defineOpenSearch(stack: Stack, lambdaRole?: iam.IRole) {
  ...
  const securityPolicy = new opensearch.CfnSecurityPolicy(stack, 'UserSearchSecurityPolicy', {
  ...
  const networkPolicy = new opensearch.CfnSecurityPolicy(stack, 'UserSearchNetworkPolicy', {
  ...
  // Data access policy
  const dataAccessPolicy = new opensearch.CfnAccessPolicy(stack, 'UserSearchDataAccessPolicy', {
