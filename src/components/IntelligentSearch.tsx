      ...
      <div className='relative'>
        <div className='relative'>
          <div className='absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 bg-white rounded-full flex items-center justify-center shadow-sm'>
            <Search className='text-brand-500 w-4 h-4' />
          </div>
          <input
            ref={inputRef}
            type='text'
            ...
            className='w-full pl-12 pr-12 py-4 text-lg border border-slate-200 rounded-xl focus:border-brand-300 focus:outline-none bg-white shadow-sm'
          />
          {query && (
            <button
              onClick={handleClear}
