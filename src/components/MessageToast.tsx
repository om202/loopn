      ...
      >
        ...
        <div className='flex gap-2'>
          <button
            ...
            className='flex-1 px-2 py-0.5 border border-indigo-600 text-indigo-600 text-xs font-light rounded-lg hover:bg-indigo-50 transition-colors'
          >
            Open Chat
          </button>
          <button
            onClick={handleClose}
            className='px-2 py-1 bg-gray-100 text-gray-600 text-xs font-medium rounded-lg hover:bg-gray-200 transition-colors'
          >
            Dismiss
          </button>
        </div>
