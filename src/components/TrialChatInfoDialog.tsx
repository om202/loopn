...
export default function TrialChatInfoDialog({
  ...
  return (
    <DialogContainer isOpen={isOpen} onClose={onClose} maxWidth='md'>
      ...
      <div className='p-6'>
        {/* Title */}
        <h3 className='text-lg font-medium text-slate-950 mb-6'>Trial Chat</h3>
        ...
        <div className='mt-6 space-y-3'>
          ...
          <button
            onClick={onClose}
            className='w-full px-4 py-2 text-sm font-medium text-brand-600 bg-white border border-brand-500 rounded-lg hover:bg-brand-50 focus:outline-none transition-colors'
          >
            Got it
          </button>
        </div>
