    ...
    <DialogContainer isOpen={isOpen} onClose={onClose} maxWidth='md'>
      <div className='p-6'>
        ...
        <div className='flex gap-3'>
          ...
          <button
            onClick={handleOk}
            className='flex-1 px-4 py-2 bg-white text-neutral-950 text-sm font-medium rounded-2xl border border-slate-200 hover:bg-slate-100 transition-colors'
          >
            Later
          </button>
        </div>
      ...
      <div className='p-6'>
        {requestCancelled ? (
          ...
          <>
            ...
            <button
              onClick={onClose}
              className='w-full px-4 py-2 bg-white text-neutral-950 text-sm font-medium rounded-2xl border border-slate-200 hover:bg-slate-100 transition-colors'
            >
              OK
            </button>
          </>
          ...
          <>
            ...
            <div className='flex gap-3 mb-4'>
              ...
              <button
                ...
                className='flex-1 px-4 py-3 bg-slate-100 text-neutral-950 text-base font-medium rounded-2xl hover:bg-slate-100 transition-colors'
              >
                Reject
              </button>
            </div>
