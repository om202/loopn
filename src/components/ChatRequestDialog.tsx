      ...
      <div className='p-6'>
        ...
        <div className='flex gap-3'>
          ...
          <button
            ...
            className='flex-1 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-2xl hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
          >
            Chat Now
          </button>
          ...
          <>
            ...
            <div className='flex gap-3 mb-4'>
              ...
              <button
                ...
                className='flex-1 px-4 py-3 bg-blue-600 text-white text-base font-medium rounded-2xl hover:bg-blue-600 transition-colors'
              >
                Accept
              </button>
