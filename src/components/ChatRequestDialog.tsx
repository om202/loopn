      ...
      <div className='p-6'>
        <div className='text-center py-6'>
          <div className='mb-6'>
            ...
            <div className='text-lg font-medium text-neutral-900 mb-3 no-email-detection'>
        ...
        <div className='flex items-center gap-2 mb-4'>
          ...
          />
          <label htmlFor='dontShowAgain' className='text-sm text-neutral-900'>
        ...
        <div className='flex gap-3'>
          ...
          <button
            onClick={handleOk}
            className='flex-1 px-4 py-2 bg-white text-neutral-900 text-sm font-medium rounded-2xl border border-neutral-200 hover:bg-neutral-100 transition-colors'
          >
            Later
          </button>
        </div>
      ...
      <div className='p-6'>
        {requestCancelled ? (
          ...
          <>
            ...
            <button
              onClick={onClose}
              className='w-full px-4 py-2 bg-white text-neutral-900 text-sm font-medium rounded-2xl border border-neutral-200 hover:bg-neutral-100 transition-colors'
            >
              OK
            </button>
          </>
          ...
          <>
            ...
            <div className='flex items-center gap-4 mb-6'>
              ...
              <div className='flex-1 min-w-0'>
                <div className='text-base font-medium text-neutral-900 truncate no-email-detection'>
                  {chatRequest.requesterEmail ||
                    `User ${chatRequest.requesterId.slice(-4)}`}
                </div>
            ...
            <div className='flex gap-3 mb-4'>
              ...
              <button
                ...
                className='flex-1 px-4 py-3 bg-neutral-100 text-neutral-900 text-base font-medium rounded-2xl hover:bg-neutral-100 transition-colors'
              >
                Reject
              </button>
            </div>
            ...
            <button
              ...
              className='w-full px-4 py-3 text-sm text-neutral-500 hover:text-neutral-900 transition-colors'
            >
              Maybe Later
            </button>
          </>
