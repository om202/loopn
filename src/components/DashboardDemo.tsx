          ...
          >
            <div className='flex items-center gap-1'>
              ...
              <div className='flex-shrink-0 flex items-center gap-1.5'>
                <button className='px-2 py-1.5 text-base font-medium rounded-xl border transition-colors flex items-center justify-center flex-shrink-0 w-[40px] h-[40px] md:w-auto md:h-auto md:gap-1.5 md:min-w-[44px] bg-brand-100 text-brand-700 border-brand-200 hover:bg-brand-100 hover:border-brand-200'>
          ...
          >
            <div className='flex items-center gap-2'>
              ...
              <div className='flex-shrink-0 flex items-center gap-2'>
                <button className='p-2 text-brand-700 hover:bg-brand-100 rounded-lg transition-colors'>
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <div className='flex flex-wrap gap-1'>
                    {user.skills.slice(0, 3).map((skill, idx) => (
                      <span
                        key={idx}
                        className='bg-brand-100 text-brand-700 text-sm px-2 py-0.5 rounded-full font-medium'
                      >
                        {skill}
                      </span>
                    ))}
          ...
          <nav className='flex-1 overflow-y-auto py-4'>
            <div className='px-2 space-y-1'>
              ...
              >
                ...
                <span className='font-medium text-base flex-1 flex items-center gap-2'>
                  Chats
                  <span className='text-sm font-bold flex items-center justify-center h-5 w-5 rounded-full text-center bg-brand-100 text-brand-700'>
                    {dummyUsers
              ...
              >
                ...
                <span className='font-medium text-base flex-1 flex items-center gap-2'>
                  Notifications
                  <span className='text-sm font-bold flex items-center justify-center h-6 w-6 rounded-full text-center bg-brand-100 text-brand-700 border border-brand-200'>
