  ...
  return (
    <div className='h-full mx-auto max-w-[860px] w-full'>
      ...
      <div className='mb-6'>
        ...
        <div className='space-y-3'>
          <div className='bg-white rounded-lg p-4 border border-gray-200'>
            ...
            <p className='text-base text-neutral-950 mb-3'>
          ...
          <div className='bg-white rounded-lg p-4 border border-gray-200'>
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <ul className='text-base text-neutral-950 space-y-1 mt-2'>
      ...
      <div className='bg-white rounded-lg p-4 border border-gray-200'>
        ...
        <p className='text-base text-neutral-950 mb-4'>
        ...
        <div className='flex flex-col sm:flex-row gap-3'>
          ...
          <button
            ...
            className='px-4 py-2 bg-white text-neutral-950 border border-gray-300 rounded-lg text-base font-medium hover:bg-stone-100 transition-colors'
          >
            Report Bug / Suggest
          </button>
        </div>
