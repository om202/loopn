      ...
      <div className='mb-6'>
        ...
        <div className='space-y-3'>
          <div className='bg-white rounded-lg p-4 border border-slate-200'>
            <h4 className='font-medium text-slate-900 text-base mb-2'>
        ...
        <div className='space-y-3'>
          <div className='bg-white rounded-lg p-4 border border-slate-200'>
            <div className='flex items-center gap-3 mb-2'>
              ...
              <h4 className='font-medium text-slate-900 text-base'>Discover</h4>
            </div>
          ...
          <div className='bg-white rounded-lg p-4 border border-slate-200'>
            <div className='flex items-center gap-3 mb-2'>
              ...
              <h4 className='font-medium text-slate-900 text-base'>Search</h4>
            </div>
            <p className='text-base text-slate-900'>
          ...
          <div className='bg-white rounded-lg p-4 border border-slate-200'>
            <div className='flex items-center gap-3 mb-2'>
              ...
              <h4 className='font-medium text-slate-900 text-base'>Chats</h4>
            </div>
            <p className='text-base text-slate-900'>
          ...
          <div className='bg-white rounded-lg p-4 border border-slate-200'>
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <ul className='text-base text-slate-900 space-y-1'>
          ...
          <div className='bg-white rounded-lg p-4 border border-slate-200'>
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <ul className='text-base text-slate-900 space-y-1 mt-2'>
