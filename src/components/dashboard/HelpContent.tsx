...
export default function HelpContent({
  ...
  return (
    <div className='h-full mx-auto max-w-[860px] w-full'>
      {/* Getting Started */}
      <div className='mb-6'>
        ...
        <div className='space-y-3'>
          ...
          <div className='bg-white rounded-lg p-4 border border-gray-200'>
            ...
            <div className='space-y-2'>
              <div className='flex items-start gap-2'>
                <span className='text-brand-700 font-medium text-base mt-0.5 flex-shrink-0'>
                  1.
                </span>
                <span className='text-base text-black'>
        ...
        <div className='space-y-3'>
          <div className='bg-white rounded-lg p-4 border border-gray-200'>
            <div className='flex items-start gap-3'>
              <AlertCircle className='w-4 h-4 text-brand-700 mt-0.5 flex-shrink-0' />
              <div>
          ...
          <div className='bg-white rounded-lg p-4 border border-gray-200'>
            <div className='flex items-start gap-3'>
              <X className='w-4 h-4 text-brand-700 mt-0.5 flex-shrink-0' />
              <div>
                <h4 className='font-medium text-black text-base mb-1'>
                  How do I end a chat?
                </h4>
      ...
      <div className='bg-white rounded-lg p-4 border border-gray-200'>
        ...
        <div className='flex flex-col sm:flex-row gap-3'>
          ...
          <button
            ...
            className='px-4 py-2 bg-white text-black border border-gray-300 rounded-lg text-base font-medium hover:bg-stone-100 transition-colors'
          >
            Report Bug / Suggest
          </button>
        </div>
