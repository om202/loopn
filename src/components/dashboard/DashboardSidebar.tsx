          ...
          <div className='border-t border-slate-100 p-2 space-y-1'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <button
                ...
                className='p-2 text-slate-1000 hover:text-slate-950 hover:bg-slate-100 rounded-lg transition-colors border border-transparent hover:border-slate-200'
            ...
            >
              ...
              <div className='flex-1'>
                ...
                <div className='text-sm text-slate-1000'>You</div>
              </div>
            </button>
          </div>
        </div>
