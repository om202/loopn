              ...
              {sidebarItems.map(({ id, icon, label, count }) => (
                <button
                  ...
                  className={`relative w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left group transition-colors duration-150 ${
                    activeSection === id
                      ? 'text-brand-600'
                      : 'text-neutral-950 hover:bg-stone-100 hover:text-neutral-950'
                  }`}
                >
          ...
          <div className='border-t border-gray-200 p-2 space-y-1'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <button
                ...
                className='p-2 text-neutral-500 hover:text-neutral-950 hover:bg-stone-100 rounded-lg transition-colors border border-transparent hover:border-gray-200'
            ...
            <button
              ...
              className={`relative w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left group transition-colors duration-150 ${
                activeSection === accountItem.id
                  ? 'text-brand-600'
                  : 'text-neutral-500 hover:bg-stone-100 hover:text-neutral-950'
              }`}
            >
