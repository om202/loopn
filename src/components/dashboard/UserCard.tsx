        ...
        <div className='flex-shrink-0 flex items-center gap-2'>
          ...
          {(loadingSummary || profileSummary) && (
            <button
              ...
              className='px-2 lg:px-3 py-1.5 text-sm lg:text-sm font-medium rounded-xl border transition-colors bg-white text-slate-900 border-slate-200 hover:bg-slate-50 hover:border-slate-200 flex items-center gap-1 lg:gap-2 flex-shrink-0'
        ...
        <div className='p-6'>
          ...
          <div className='flex'>
            <button
              ...
              className='w-full px-4 py-2 text-sm font-medium text-slate-900 bg-slate-100 rounded-lg hover:bg-slate-200 focus:outline-none transition-colors'
            >
              OK
            </button>
          </div>
