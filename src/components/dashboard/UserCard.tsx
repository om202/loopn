    ...
    >
      <div className='flex items-center gap-3 lg:gap-4'>
        ...
        <div className='flex-1 min-w-0'>
          <div className='font-medium text-black text-sm lg:text-base mb-1 truncate no-email-detection'>
        ...
        <div className='flex-shrink-0 flex items-center gap-2'>
          ...
          {(loadingSummary || profileSummary) && (
            <button
              ...
              className='px-2 lg:px-3 py-1.5 text-sm lg:text-sm font-medium rounded-xl border transition-colors bg-white text-black border-slate-200 hover:bg-slate-100 hover:border-slate-200 flex items-center gap-1 lg:gap-2 flex-shrink-0'
              disabled={loadingSummary}
            >
              <Info className='w-4 lg:w-4 h-4 lg:h-4 text-black flex-shrink-0' />
              ...
              return (
                <div className='text-sm lg:text-sm text-right'>
                  ...
                  <div className='text-slate-500 flex items-center justify-end gap-1'>
                    <Clock className='w-3 h-3 text-slate-500 hover:text-black cursor-pointer transition-colors' />
                    {timeRemaining}
                  </div>
                </div>
              );
            ...
            return (
              ...
              >
                {pendingRequests.has(userPresence.userId) ? (
                          ...
                          return timeRemaining ? (
                            <div className='text-right'>
                              ...
                              <div className='flex items-center justify-end gap-1'>
                                {timeRemaining}
                                <Clock
                                  className='w-4 h-4 text-slate-500 hover:text-black cursor-pointer transition-colors'
                                  onClick={e => {
                                    e.stopPropagation();
                                  }}
                                />
                  ...
                  <>
                    <CheckCircle2 className='w-4 lg:w-4 h-4 lg:h-4 text-black flex-shrink-0' />
                    Start
                  </>
                )}
              </button>
        ...
        <div className='p-6'>
          ...
          <div className='mb-4'>
            ...
            {loadingSummary ? (
              ...
              <div className='text-sm text-black leading-relaxed bg-slate-100 rounded-lg p-4 border border-slate-200'>
                {profileSummary}
              </div>
            ) : (
          ...
          <div className='flex'>
            <button
              ...
              className='w-full px-4 py-2 text-sm font-medium text-black bg-slate-100 rounded-lg hover:bg-slate-100 focus:outline-none transition-colors'
            >
              OK
            </button>
          </div>
