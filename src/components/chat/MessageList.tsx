        ...
        <div className='w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6 sm:py-8'>
          <div className='flex flex-col items-center justify-center text-center py-20'>
            <div className='w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mb-4'>
              <MessageCircle className='w-8 h-8 text-slate-1000' />
            </div>
            <h3 className='text-lg font-medium text-slate-950 mb-2'>
              No messages yet
            </h3>
            <p className='text-slate-1000 max-w-sm'>Send your first message</p>
          </div>
          <div ref={messagesEndRef} />
        </div>
      </div>
      ...
      >
        ...
        {hasMoreMessages ? (
          <div ref={loadMoreRef} className='flex justify-center py-4'>
            {isLoadingMore ? (
              <div className='flex items-center space-x-2 text-slate-1000'>
              ...
              <button
                ...
                className='px-4 py-2 text-sm text-brand-500 hover:text-brand-700 hover:bg-brand-100 rounded-lg transition-colors duration-200'
              >
                Load older messages
              </button>
            )}
            ...
            <React.Fragment key={message.id}>
              ...
              {shouldShowNewMessagesSeparator && (
                <div className='flex items-center justify-center my-4 px-4'>
                  <div className='text-slate-1000 text-sm font-medium'>
                    New messages
                  </div>
                </div>
              )}
