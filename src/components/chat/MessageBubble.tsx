      ...
      <div className='relative flex items-center gap-3 max-w-full'>
        ...
        >
            ...
            {message.isDeleted ? (
              <div
                className={`p-2.5 rounded-2xl border shadow-sm ${
                  isOwnMessage
                    ? 'bg-neutral-100 text-neutral-500 border-neutral-200 rounded-br-md'
                    : 'bg-neutral-100 text-neutral-500 border-neutral-200 rounded-bl-md'
                }`}
              >
              ...
              >
                {repliedToMessage && (
                  ...
                  >
                    <div
                      className={`text-sm ${
                        isOwnMessage ? 'text-brand-100' : 'text-neutral-900'
                      } mb-1`}
                    >
                      Replying to{' '}
          ...
          {onReplyToMessage && !message.isDeleted && (
            ...
            >
              <div
                className={`bg-white/95 backdrop-blur-md border border-neutral-200 rounded-full px-2 py-1.5 gap-3 flex items-center ${
                  isOwnMessage ? 'flex-row-reverse' : 'flex-row'
                }`}
              >
                <button
