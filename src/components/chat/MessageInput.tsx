      ...
      {replyToMessage && (
        <div className='bg-neutral-100 border-t border-neutral-200 px-4 sm:px-6 lg:px-8 xl:px-12 py-3'>
          <div className='relative pr-8'>
            <div className='flex items-center text-sm text-neutral-900 mb-3'>
              <svg
            ...
            <div className='text-base text-neutral-900 bg-white rounded-lg px-4 py-3 border border-neutral-200'>
              {getRepliedToContent(replyToMessage.content)}
            </div>
            {onCancelReply && (
              <button
                onClick={onCancelReply}
                className='absolute top-0 right-0 p-1 text-neutral-500 hover:text-neutral-900 transition-colors rounded-full hover:bg-neutral-100'
                title='Cancel reply'
              >
                <X className='w-4 h-4' />
              </button>
            ...
            <div className='flex gap-3 items-end'>
              <div className='flex-1 relative'>
                ...
                <button
                  ...
                  disabled={disabled}
                  className={`absolute right-2 top-1/2 transform -translate-y-1/2 text-neutral-500 hover:text-neutral-900 transition-all duration-200 p-2 rounded-full hover:bg-neutral-100 focus:outline-none disabled:opacity-50 ${
