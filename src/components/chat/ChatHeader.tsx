      ...
      <div className='w-full px-3 sm:px-4 lg:px-6'>
        <div className='py-2 sm:py-3'>
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <button
              onClick={onBack}
              className='p-1.5 sm:p-2 -ml-1 sm:-ml-2 text-slate-500 hover:text-black hover:bg-slate-100 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2'
            >
              <svg
                  ...
                  timeLeft !== 'Expired' && (
                    <div className='flex items-center gap-1 sm:gap-2 text-sm sm:text-sm'>
                      ...
                      <button
                        ...
                        className='flex items-center gap-1 sm:gap-1.5 px-3 sm:px-3 lg:px-4 py-2 sm:py-2 bg-blue-600 hover:bg-blue-600 disabled:bg-blue-600 text-white rounded-lg shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 disabled:cursor-not-allowed flex-shrink-0'
                      >
                        <Image
                          src='/connect-icon.svg'
                          alt='Connect'
