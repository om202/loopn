...
export default function ChatHeader({
  ...
  return (
    ...
    >
                  ...
                  <div className='flex items-center gap-2 sm:gap-3 md:gap-4'>
                    <div className='flex items-center gap-1 sm:gap-2 text-sm sm:text-sm text-black'>
                      <button
                        ...
                        className='flex items-center gap-1 text-slate-500 hover:text-black transition-colors p-1 rounded-full hover:bg-slate-100 flex-shrink-0'
      ...
      >
        <div className='p-6'>
          <h3 className='text-lg font-semibold text-black mb-4'>Chat Ended</h3>
