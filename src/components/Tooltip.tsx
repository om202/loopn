    ...
    <>
      ...
      {isVisible && (
        <div
          ref={tooltipRef}
          style={tooltipStyle}
          className='bg-white text-zinc-900 text-sm px-2 py-1 rounded-md shadow-[0_4px_12px_rgba(0,0,0,0.15)] whitespace-nowrap pointer-events-none animate-in fade-in-0 zoom-in-95 duration-200'
        >
          {content}
