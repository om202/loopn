                ...
                if (moreMatch) {
                  ...
                  return (
                    <>
                      ...
                      <span className='inline-flex items-center px-2 py-1 text-sm font-medium bg-brand-100 text-brand-600 rounded-full'>
                        +{count} more
                      </span>
                    </>
                  );
          ...
          'requesterId' in notification.data ? (
              ...
              return (
                <>
                  <button
                    ...
                    className='px-3 py-2 bg-transparent text-brand-600 text-sm font-medium rounded-lg hover:bg-brand-100 disabled:opacity-50 transition-colors border border-brand-200'
                  >
                    Accept
                  </button>
                  <button
                    ...
                    disabled={decliningId === notification.id}
                    className='px-3 py-2 text-sm font-medium text-neutral-950 bg-white border border-gray-200 rounded-lg hover:bg-stone-100 disabled:opacity-50 transition-colors'
                  >
            ...
            <>
              <button
                ...
                className='px-3 py-2 bg-transparent text-brand-600 text-sm font-medium rounded-lg hover:bg-brand-100 transition-colors border border-brand-200'
              >
                Reply
              </button>
              <button
                ...
                className='px-3 py-2 text-sm font-medium text-neutral-950 bg-white border border-gray-200 rounded-lg hover:bg-stone-100 transition-colors'
              >
                Mark as Read
              </button>
            </>
