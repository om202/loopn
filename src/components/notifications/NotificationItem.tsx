        ...
        <div className='flex-1 min-w-0'>
          ...
          >
            ...
            <div className='flex items-center gap-2 mb-0.5'>
              <h4 className='text-base font-medium text-gray-900 truncate no-email-detection'>
                {notification.title}
              </h4>
            ...
            <div className='flex items-center gap-2'>
              {(() => {
                ...
                if (moreMatch) {
                  ...
                  return (
                    <>
                      <p className='text-base text-gray-500'>{baseContent}</p>
                ...
                return <p className='text-base text-gray-500'>{content}</p>;
              })()}
            </div>
          </div>
        </div>
          ...
          'requesterId' in notification.data ? (
              ...
              return (
                <>
                  ...
                  <button
                    ...
                    disabled={decliningId === notification.id}
                    className='px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 disabled:opacity-50 transition-colors'
                  >
            ...
            <>
              ...
              <button
                ...
                className='px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors'
              >
                Mark as Read
              </button>
            </>
