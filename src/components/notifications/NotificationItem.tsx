          ...
          'requesterId' in notification.data ? (
              ...
              return (
                <div className='flex items-center gap-2 mt-3'>
                  ...
                  <button
                    ...
                    disabled={decliningId === notification.id}
                    className='px-3 py-1.5 bg-brand-600 text-white text-sm font-semibold rounded-lg hover:bg-brand-600 disabled:opacity-50 transition-colors'
                  >
                    Confirm
                  </button>
                </div>
            ...
            <div className='flex items-center gap-2 mt-3'>
              <button
                ...
                className='px-3 py-1.5 bg-brand-600 text-white text-sm font-semibold rounded-lg hover:bg-brand-600 transition-colors'
              >
                Reply
              </button>
              <button
