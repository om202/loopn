            ...
            <div className='text-center lg:text-left'>
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center lg:justify-start'>
                ...
                <button
                  ...
                  className='text-slate-1000 hover:text-slate-950 text-xl font-semibold transition-colors flex items-center justify-center gap-2'
                >
                  See how it works
                  ...
                  <div className='w-full px-3 sm:px-4'>
                    <div className='py-2 sm:py-3'>
                      <div className='flex items-center gap-2 sm:gap-3'>
                        ...
                        <button
                          disabled
                          className='p-1.5 sm:p-2 -ml-1 sm:-ml-2 text-slate-1000 hover:text-slate-950 hover:bg-slate-100 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 cursor-not-allowed opacity-50'
                        >
                          <svg
                    ...
                    <div className='flex gap-3 items-end'>
                      <div className='flex-1 relative'>
                        ...
                        <button
                          type='button'
                          disabled
                          className='absolute right-2 top-1/2 transform -translate-y-1/2 text-slate-1000 hover:text-slate-950 transition-all duration-200 p-2 rounded-full hover:bg-slate-100 focus:outline-none disabled:opacity-50 cursor-not-allowed'
                        >
      ...
      <section className='py-12 sm:py-16 bg-white relative'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='mt-16 text-center'>
            ...
            <p className='text-slate-600 mb-8 text-2xl'>
      ...
      <footer className='bg-white py-12 border-t border-slate-200'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='text-slate-600 text-2xl text-center max-w-2xl mx-auto mb-8 leading-relaxed'>
