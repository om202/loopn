...
export default function HomePage() {
  ...
  return (
    <main className='min-h-screen bg-white'>
      ...
      <nav className='bg-white border-b border-gray-100 sticky top-0 z-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            ...
            <div className='flex items-center'>
              <Link href={authLink}>
                <button className='bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-lg font-medium transition-colors flex items-center gap-2'>
      ...
      {/* Hero Section */}
      <section className='min-h-[calc(100vh-64px)] bg-gray-50 flex items-center relative'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-8 lg:py-12'>
          <div className='grid lg:grid-cols-2 gap-8 lg:gap-12 items-center'>
            {/* Left column - Content */}
            <div className='text-center lg:text-left'>
              <h1 className='text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-semibold text-gray-900 mb-6 leading-tight'>
                Connect and Grow{' '}
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-20 mb-6'>
                <Link href={authLink} className='w-full sm:w-auto'>
                  <button className='w-full bg-indigo-600 hover:bg-indigo-700 text-white px-10 py-4 rounded-lg text-lg font-medium transition-all duration-200 flex items-center justify-center gap-2'>
            ...
            <div className='relative'>
              ...
              <div className='space-y-8 max-w-sm mx-auto mt-8 lg:mt-12'>
                ...
                <div className='flex flex-col space-y-2 opacity-0 animate-[slideUpFade_0.5s_ease-out_0.5s_forwards]'>
                  ...
                  <div className='bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm border border-gray-100 text-gray-600 text-sm max-w-[85%]'>
                ...
                <div className='flex flex-col items-end space-y-2 opacity-0 animate-[slideUpFade_0.5s_ease-out_1.5s_forwards]'>
                  ...
                  <div className='bg-indigo-600 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm text-white text-sm max-w-[85%]'>
      ...
      <section className='py-16 sm:py-20 bg-white'>
        ...
        <div className='absolute inset-0 -z-10'>
          <div className='absolute top-1/4 left-0 w-72 h-72 bg-gray-100/30 rounded-full blur-3xl' />
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='text-center max-w-3xl mx-auto mb-12 relative'>
            <h2 className='text-2xl sm:text-3xl lg:text-4xl font-medium text-gray-900 mb-4'>
              ...
              <span className='text-indigo-600'>professional networking</span>
            </h2>
          ...
          <div className='grid lg:grid-cols-3 gap-6 mb-12'>
            ...
            <div className='bg-white rounded-lg p-5 border border-gray-200 h-full'>
          ...
          <div className='text-center mt-28'>
            <Link href={authLink}>
              <button className='inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-10 py-4 rounded-lg text-lg font-medium transition-all duration-200 group'>
                {ctaText}
                <ArrowRight className='w-5 h-5 group-hover:translate-x-1 transition-transform' />
              </button>
            </Link>
      ...
      <section className='py-16 sm:py-20 bg-gray-50'>
        {/* Background decoration */}
        <div className='absolute inset-0 -z-10'>
          <div className='absolute top-1/3 right-0 w-96 h-96 bg-indigo-100/20 rounded-full blur-3xl' />
        </div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid lg:grid-cols-3 gap-6 relative'>
            {/* Step 1 */}
            <div className='relative'>
              <div className='bg-white rounded-lg p-5 border border-gray-200 relative h-full'>
                {/* Step number */}
                <div className='absolute -top-2.5 right-3 w-7 h-7 bg-indigo-600 rounded-full flex items-center justify-center text-white font-medium text-sm'>
                  1
                </div>
                {/* Content */}
                <h3 className='text-lg font-medium text-gray-900 mb-2'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
            <div className='bg-white border border-gray-200 rounded-lg p-5'>
              ...
              <blockquote className='text-gray-700 mb-3 text-sm'>
      ...
      <footer className='bg-gray-50 py-10 border-t border-gray-200'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex flex-col items-center justify-center'>
            ...
            <p className='text-gray-600 text-center max-w-md mb-3 text-sm'>
