      ...
      <nav className='bg-white border-b border-gray-200 sticky top-0 z-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            ...
            <div className='flex items-center'>
              <Link href={authLink}>
                <button className='bg-white hover:bg-brand-100 text-brand-600 border border-gray-200 px-6 py-2.5 rounded-lg transition-colors flex items-center gap-2'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8'>
            ...
            <div className='group bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full'>
              ...
              <div className='flex items-center gap-4 mt-auto'>
                ...
                />
                <div>
                  <p className='font-bold text-neutral-950 text-sm'>Sarah Johnson</p>
            ...
            <div className='group bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col h-full'>
              ...
              <div className='flex items-center gap-4 mt-auto'>
                ...
                />
                <div>
                  <p className='font-bold text-neutral-950 text-sm'>Michael Chen</p>
                  <p className='text-neutral-500 text-sm'>
