        ...
        <div className='bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 lg:p-8'>
          ...
          <div className='flex justify-end mb-6'>
            <button
              ...
              className='text-sm text-slate-600 hover:text-b_red-600 transition-colors'
            >
              Sign Out
            </button>
          </div>
          ...
          <div className='flex justify-between mt-8'>
            <button
              ...
              className={`px-6 py-3 rounded-xl font-medium border bg-white text-slate-900 border-slate-200 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-brand-500 disabled:opacity-50 disabled:cursor-not-allowed`}
            >
              Previous
            </button>
