        ...
        <div className='bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 lg:p-8'>
          ...
          <div className='flex justify-end mb-6'>
            <button
              ...
              className='text-sm text-zinc-500 hover:text-b_red-600 transition-colors'
            >
              Sign Out
            </button>
          </div>
            ...
            <Link href='/home' className='inline-block'>
              <div className='flex items-center justify-center space-x-3 mb-3 cursor-pointer hover:opacity-80 transition-opacity'>
                <Image
                  ...
                  priority
                />
                <h1 className='text-3xl font-bold text-zinc-950'>Loopn</h1>
              </div>
            </Link>
            <p className='text-zinc-950 text-base mb-6'>
                    ...
                    <div
                      className={`relative z-10 w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold border ${
                        step <= currentStep
                          ...
                          : 'bg-white text-zinc-500 border-slate-200'
                      }`}
                    >
                      {step}
                    </div>
            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-8'>
                {INTERESTS_GROUPS.map((group, idx) => (
                  ...
                  >
                    <div className='text-sm font-medium text-zinc-950 mb-4'>
                      {group.title}
                    </div>
          ...
          <div className='flex justify-between mt-8'>
            <button
              ...
              className={`px-6 py-3 rounded-xl font-medium border bg-white text-zinc-950 border-slate-200 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-brand-500 disabled:opacity-50 disabled:cursor-not-allowed`}
            >
              Previous
            </button>
