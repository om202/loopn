          ...
          <div className='bg-white rounded-lg shadow-sm border border-neutral-200 p-6'>
            ...
            <div className='bg-neutral-50 rounded-lg p-4 mb-6'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm'>
                <div>
                  <span className='text-neutral-600'>Query Embedding:</span>
                ...
                <div>
                  <span className='text-neutral-600'>Profile Fetching:</span>
                  <span className='font-medium ml-2'>
                        ...
                        <div className='flex-1 min-w-0'>
                          ...
                          {result.embeddingText && (
                            <details className='mt-2'>
                              ...
                              <div className='mt-2 p-2 bg-neutral-50 rounded text-xs text-neutral-600 max-h-20 overflow-y-auto'>
